...
x=b.length
if(y*x<=16){w=Array(x)
for(v=new J.m1(a,y,0,null);v.D();){u=v.c
s=J.t(u)
z=0
while(!0){if(!(z<x)){t=!0
break}if(s.m(u,b[z])){w[z]=!0
t=!1
break}++z}if(t)c.remove(u)}for(z=0;z<x;++z)if(w[z]!==!0)c.add(b[z])}else{r=P.Py(null,null,null,null,null)
for(v=new J.m1(b,b.length,0,null);v.D();)r.q(0,v.c,!1)
for(v=new J.m1(a,a.length,0,null);v.D();){u=v.c
if(!r.x4(u))c.remove(u)
else r.q(0,u,!0)}r.aN(0,new D.lY(c))}}else if(b!=null&&b.length>0)for(z=0;z<b.length;++z)c.add(b[z])
return},
jd:{
...
if((z&14)!==0){y=this.y
x=this.d
if(x!=null){w=y.classList
w.add(x)}else w=null
x=this.r
if(x!=null){if(w==null)w=y.classList
for(v=0;v<x.length;++v)w.add(x[v])}if((z&4)!==0){z=this.z
z.r=this.x
z.Li()}else if(this.x!=null){u=(a.c&2)!==0
for(v=0;v<J.wS(this.x);++v)this.xC(J.Tf(this.x,v),null,a,u)}}},
...
y=this.r
w=a.r
if(y==null?w!=null:y!==w)D.MM(y,w,x.classList)
if((z&4)!==0){a.z=this.z
...
z=this.x
y=a.x
if(z==null?y!=null:z!==y){this.z.r=z
v=!0}if(v){this.z.zB()
